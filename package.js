Package.describe({
  name: 'wiseplat:elements',
  summary: 'Basic elements for Dapps',
  version: '0.7.17',
  git: 'http://github.com/wiseplat/meteor-package-elements'
});
...
Package.onUse(function(api) {
  ...
  api.use('wiseplat:web3@0.15.2', 'client');
  api.use('wiseplat:tools@0.4.0', 'client');
  ...
  api.imply(['frozeman:template-var','wiseplat:tools'], 'client');


  api.export(['WshElements'], 'client');
  ...
  api.addFiles('wshelements.js', 'client');
