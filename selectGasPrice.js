...
Template['dapp_selectGasPrice'].helpers({
    ...
    */
    'fee': function(){
        if(_.isFinite(TemplateVar.get('feeMultiplicator')) && _.isFinite(this.gas)) {
            ...
            // return the fee
            return WshTools.formatBalance(calculateGasInWei(template, this.gas, this.gasPrice).toString(10), '0,0.[000000000000000000]', this.unit);
        }
    },
    /**
    ...
    */
    'unit': function(){
        var unit = this.unit || WshTools.getUnit();
        if(unit)
